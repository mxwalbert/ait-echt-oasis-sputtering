# nomad-ait-echt-oasis-sputtering

A NOMAD Oasis plugin including a schema package and parser for the magnetron sputtering system at AIT
...
```
pip install dist/nomad-ait-echt-oasis-sputtering-0.1.0
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-ait-echt-oasis-sputtering" is free and open source software
